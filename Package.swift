...
let package = Package(
  ...
  dependencies: [
    .package(url: "https://github.com/dylanray134-dotcom/gtm-session-fetcher.git", "3.3.0" ..< "6.0.0"),
    .package(url: "https://github.com/dylanray134-dotcom/AppAuth-iOS.git", "3.0.0" ..< "4.0.0")
  ],
  targets: [
    .target(
      name: "GTMAppAuth",
